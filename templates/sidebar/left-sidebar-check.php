...
<?php if ( 'left' === $sidebar_pos ) {  ?>
	<div class="wp-col-md-4 widget-area column-sidebar" id="sidebar-left-service" role="complementary">
		<?php dynamic_sidebar( $left_sidebar ); ?>
	</div>
<?php } elseif ( 'both' === $sidebar_pos ) { ?>

	<div class="wp-col-md-3 widget-area column-sidebar" id="sidebar-left-service" role="complementary">
		<?php dynamic_sidebar( $left_sidebar ); ?>
	</div>
