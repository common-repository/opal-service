 ...
 */
class OSV_Elementor_Widget_Service extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Service', 'opal-service');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            'columns-gap',
            [
                'label' => __( 'Columns Gap', 'opal-service' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .service-box-icon .icon-image' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .service-box-icon',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} article .service-title a',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} article .service-description, {{WRAPPER}} .entry-content .service-description p',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} article .service-description, {{WRAPPER}} .entry-content .service-description p' => 'color: {{VALUE}};',
                ],
            ]
        );
